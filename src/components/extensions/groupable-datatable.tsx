    ...
    <div className="space-y-4 w-full">
      ...
      {searchable && (
        <div className="relative">
          ...
          <div className="flex flex-wrap items-center gap-2 bg-background py-2 pr-3 pl-8 border rounded-md">
              ...
              <div className="space-y-4 py-4">
                ...
                <div className="flex gap-2">
                  ...
                  <div className="ml-auto">
                    ...
                    >
                      <Plus className="mr-1 w-4 h-4" /> Regla
                    </Button>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  {filterState.rules.length === 0 && (
                    <div className="py-4 text-muted-foreground text-center">
                      No hay reglas de filtro. Haga clic en &quot;Regla&quot;
                      para añadir una.
                    </div>
                  )}
                </div>
